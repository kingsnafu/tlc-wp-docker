...
export async function extractPosts(config, { yoastMeta = {}, taxonomies = {}, mediaMap = {}, authorMap = {} } = {}) {
  ...
  for (const post of posts) {
    ...
    const frontMatter = {
      ...
      author: authorMap[post.author] || `User ${post.author}`,
    ...
    if (post.featured_media && mediaMap[post.featured_media]) {
      frontMatter.featured_image = mediaMap[post.featured_media];
    }
